// bit version: 8.10.0-pre-03-pre-01
...
self.assetsExclude = [
    ...
    /Client\.Web\.styles\.css$/ // In .NET 8, an inexistent CSS file is inadvertently included in the assets list under the name 'WordSkills.Client.Web.styles.css.'
